                        ...
                        <div className="space-y-2">
                          {groups[groupName].map((n, i) => (
                            <button
                              ...
                              className={`w-full text-left flex items-start gap-3 p-4 rounded-xl border transition-all duration-300 hover:shadow-md animate-fade-in-up ${
                                n.isRead ? 'bg-white border-[#E7E5DD]' : 'bg-teal-bg/40 border-teal-brand/20'
                              }`}
